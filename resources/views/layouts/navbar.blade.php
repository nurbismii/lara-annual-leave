<nav class="navbar navbar-expand-lg blur blur-rounded top-0 z-index-fixed shadow position-absolute my-3 py-2 start-0 end-0 mx-4">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
      <ul class="navbar-nav navbar-nav-hover ms-lg-4 ps-lg-5 w-100">
        <li class="nav-item dropdown dropdown-hover">
          ...
          <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages" data-bs-popper="static">
            <div class="d-none d-lg-block">
              ...
              <a href="#cuti-tahunan" class="dropdown-item border-radius-md">
                <span class="ps-3">Cuti Tahunan</span>
              </a>
              <a href="#paid-leave" class="dropdown-item border-radius-md">
                <span class="ps-3">Paid Leave</span>
              </a>
              <a href="#unpaid-leave" class="dropdown-item border-radius-md">
                <span class="ps-3">Unpaid Leave</span>
              </a>
            </div>
          </div>
        </li>
